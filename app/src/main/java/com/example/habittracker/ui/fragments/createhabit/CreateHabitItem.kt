...
import com.example.habittracker.util.Calculation
...
class CreateHabitItem : Fragment(R.layout.fragment_create_habit_item),
    TimePickerDialog.OnTimeSetListener, android.app.DatePickerDialog.OnDateSetListener{
    ...
    private fun drawableSelected() {
        ...
        iv_smokingSelected.setOnClickListener {
            ...
            drawableSelected = R.drawable.ic_smoke_free
    ...
    @SuppressLint("SetTextI18n")
    override fun onTimeSet(p0: TimePicker?, hourOfDay: Int, minuteX: Int) {
        cleanTime = Calculation.cleanTime(hourOfDay, minuteX)
